...
[[maybe_unused]] static const char* JOYINIPATH = "./setting.ini";	// Load settings ini path
...
[[maybe_unused]] static const char* JOYNAME[MAXPLAYERS] = {"JoyPad1","JoyPad2","JoyPad3","JoyPad4"};
													// ini Item name to read from
[[maybe_unused]] static const char* KEYNAME[MAXBUTTONS+1] = {"Player","Button1","Button2","Button3","Button4"};
													// Item name
