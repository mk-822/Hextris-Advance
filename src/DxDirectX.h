// ----------------------------------------------------------------------------
//
//		�c�w���C�u����		DirectX �֘A��`�p�w�b�_�t�@�C��
//
//				Ver2.22f
//
// ----------------------------------------------------------------------------
...
//		virtual HRESULT __stdcall NonUse00					( void ) = 0 ;				// DuplicateSoundBuffer( LPDIRECTSOUNDBUFFER pDSBufferOriginal, LPDIRECTSOUNDBUFFER *ppDSBufferDuplicate ) = 0 ;
	...
	public :
		...
		virtual HRESULT __stdcall NonUse01					( void ) = 0 ;				// CreateVertexBuffer( void ) = 0 ;			// CreateVertexBuffer( LPD3DVERTEXBUFFERDESC, LPDIRECT3DVERTEXBUFFER7*, DWORD ) = 0 ;
	...
	public :
		...
		virtual HRESULT __stdcall NonUse16					( void ) = 0 ;				// DrawIndexedPrimitiveVB( D3DPRIMITIVETYPE,LPDIRECT3DVERTEXBUFFER7,DWORD,DWORD,LPWORD,DWORD,DWORD ) = 0 ;
